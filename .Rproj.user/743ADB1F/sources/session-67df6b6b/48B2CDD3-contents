...
setwd("C:/Users/dburruss/Documents/HSP/")

##read in the table of new inforamtion
clean_data <- read_xlsx("ESRI_online_map/2024_clean_data/HSP_Map_Data.xlsx",
                      sheet = "new_data") 

##read in the existing shapefile
shapefile <- vect("ESRI_online_map/2024_hsp_shapefile/HSP_Projects.shp") 
...
write.csv(look,"C:/Users/dburruss/Documents/HSP/ESRI_online_map/2024_clean_data/new_data_coord.csv")

#write.csv(look %>% dplyr::select(FID, X, Y),"C:/Users/dburruss/Documents/HSP/ESRI_online_map/new_data_coords.csv")

#look

writeVector(shape_new,"C:/Users/dburruss/Documents/HSP/ESRI_online_map/HSP_project_shapefile_upload/HSP_Projects.kml", overwrite=TRUE)
